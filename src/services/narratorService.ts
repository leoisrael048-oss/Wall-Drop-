...
import { NarratorConfig, NARRATOR_SPEED, VICIANTE_VOICE_PRESETS } from './narratorConfig';
...
export const NARRATOR_PHRASES: Record<string, Partial<Record<NarratorEventCategory, string[]>>> = {
  pt: {
    epicMoment: [
      'O ABISMO SE ABRE PARA VOCÊ, {name}! SINTA O PODER!',
      'AS PAREDES TREMEEM! ELAS SABEM QUE VOCÊ CHEGOU!',
      'MOMENTO HISTÓRICO! VOCÊ ESTÁ FAZENDO ISSO ACONTECER!',
      'O NEON CHORA DE EMOÇÃO! QUE PERFORMANCE MAGNÍFICA!',
      'ISSO É WALL DROP NO SEU MAIS ALTO NÍVEL!',
      'A QUEDA NUNCA VIU ALGO ASSIM! VOCÊ É ÚNICO!',
    ],
    spineChilling: [
      'A PAREDE SENTIU O IMPACTO DA SUA ALMA, {name}!',
      'VOCÊ ENCONTROU O ABISMO... E O ABISMO RECUOU!',
      'SINTA O CALAFRIO NA ESPINHA! ISSO É PODER PURO!',
      'POR UM MILÍMETRO VOCÊ ESCAPOU DA MORTE! O ABISMO TREMEU!',
      'O NEON FICOU SEM COR DIANTE DA SUA GRANDEZA!',
      'VOCÊ DANÇOU COM A MORTE E VENCEU!',
    ],
    addictiveReward: [
      'ASSISTA UM ANÚNCIO E GANHE MAIS UMA CHANCE! NÃO QUER TENTAR DE NOVO?',
      'A GLÓRIA ESPERA POR VOCÊ! SÓ MAIS UM VÍDEO E VOCÊ VOLTA MAIS FORTE!',
      'VOCÊ SENTE AQUELA COCEIRA DE QUERER MAIS... É SÓ CLICAR!',
      'O NARRADOR DISSE QUE VOCÊ NÃO VAI CONSEGUIR... QUER PROVAR DO CONTRÁRIO?',
      'CADA ANÚNCIO TE DEIXA MAIS FORTE! O ABISMO TE RECOMPENSA!',
      'VOCÊ É INCANSÁVEL! O NEON TE RECOMPENSA!',
    ],
    comebackKing: [
      'VOCÊ CAIU, MAS LEVANTOU MAIS FORTE QUE NUNCA! A HISTÓRIA CONTINUA!',
      'A PAREDE PENSOU QUE TE TINHA... MAS VOCÊ É INDESTRUTÍVEL!',
      'RESSURREIÇÃO ÉPICA! O ABISMO NUNCA VIU ALGO ASSIM!',
      'DE VOLTA PARA A GLÓRIA! {name} É IMORTAL!',
      'A FENIX RESSURGE DAS CINZAS! VOCÊ É LENDÁRIO!',
      'O ABISMO TE SUBESTIMOU... ELE NÃO SABE QUEM VOCÊ É!',
    ],
    recordBreaker: [
      'RECORDE HISTÓRICO! VOCÊ ESCREVEU SEU NOME NAS ESTRELAS!',
      'O ABISMO TESTEMUNHOU A GRANDEZA! MOMENTO INESQUECÍVEL!',
      'VOCÊ QUEBROU BARREIRAS! VOCÊ QUEBROU RECORDES!',
      'NOVA ERA DA QUEDA! O LEGADO DE {name} COMEÇA AGORA!',
      'O TOPO DO MUNDO É SEU! VOCÊ É O MELHOR!',
      'NINGUÉM NUNCA FEZ ISSO ANTES! VOCÊ É HISTÓRIA!',
    ],
    intenseAction: [
      'REFLEXOS DE AÇO! MENTE DE TITÂNIO! VOCÊ É MÁQUINA DE GUERRA!',
      'VELOCIDADE DA LUZ! PRECISÃO CIRÚRGICA! VOCÊ É PERFEIÇÃO!',
      'NENHUMA PAREDE TE PARA! NENHUM OBSTÁCULO TE DERRUBA!',
      'VOCÊ NÃO É MAIS UM JOGADOR... VOCÊ É O PRÓPRIO JOGO!',
      'A QUEDA É SEU DOMÍNIO! NINGUÉM TE SUPERA!',
      'SUA AGILIDADE É SOBRENATURAL! VOCÊ É UMA LENDA!',
    ],
    motivationalBoost: [
      'VOCÊ É CAPAZ DE FEITOS INCRÍVEIS! A QUEDA É O SEU PALCO!',
      'CADA TENTATIVA TE APROXIMA DA GLÓRIA! NÃO PARE AGORA!',
      'O ÚNICO LIMITE É SUA MENTE! VOCÊ NASCEU PARA ISSO!',
      'A QUEDA ESPERA SEU TOQUE DE MESTRE, {name}!',
      'VOCÊ TEM O PODER DE REESCREVER A HISTÓRIA!',
      'O ABISMO TE RECONHECE COMO SEU MESTRE!',
    ],
    frenzyMode: [
  ...
  en: {
    epicMoment: [
      'THE ABYSS OPENS FOR YOU, {name}! FEEL THE POWER!',
      'THE WALLS ARE SHAKING! THEY KNOW YOU HAVE ARRIVED!',
      'HISTORIC MOMENT! YOU ARE MAKING THIS HAPPEN!',
      'THE NEON CRIES WITH EMOTION! MAGNIFICENT PERFORMANCE!',
      'THIS IS WALL DROP AT ITS HIGHEST LEVEL!',
    ],
    spineChilling: [
      'THE WALL FELT THE IMPACT OF YOUR SOUL, {name}!',
      'YOU FACED THE ABYSS... AND THE ABYSS BACKED DOWN!',
      'FEEL THE CHILL DOWN YOUR SPINE! THIS IS PURE POWER!',
      'BY A MILLIMETER YOU ESCAPED DEATH! THE ABYSS TREMBLED!',
      'YOU DANCED WITH DEATH AND WON!',
    ],
    addictiveReward: [
      'WATCH AN AD AND GET ANOTHER CHANCE! DONT YOU WANT TO TRY AGAIN?',
      'GLORY AWAITS YOU! JUST ONE MORE VIDEO AND YOU COME BACK STRONGER!',
      'YOU FEEL THAT ITCH FOR MORE... JUST CLICK!',
      'THE NARRATOR SAID YOU CANNOT DO IT... WANT TO PROVE HIM WRONG?',
      'EVERY AD MAKES YOU STRONGER! THE ABYSS REWARDS YOU!',
    ],
    comebackKing: [
      'YOU FELL, BUT ROSE STRONGER THAN EVER! THE STORY CONTINUES!',
      'THE WALL THOUGHT IT HAD YOU... BUT YOU ARE INDESTRUCTIBLE!',
      'EPIC RESURRECTION! THE ABYSS HAS NEVER SEEN ANYTHING LIKE THIS!',
      'BACK TO GLORY! {name} IS IMMORTAL!',
      'THE PHOENIX RISES FROM THE ASHES! YOU ARE LEGENDARY!',
    ],
    recordBreaker: [
      'HISTORIC RECORD! YOU WROTE YOUR NAME IN THE STARS!',
      'THE ABYSS WITNESSED GREATNESS! UNFORGETTABLE MOMENT!',
      'YOU BROKE BARRIERS! YOU BROKE RECORDS!',
      'NEW ERA OF THE DROP! THE LEGACY OF {name} BEGINS NOW!',
      'THE TOP OF THE WORLD IS YOURS! YOU ARE THE BEST!',
    ],
    intenseAction: [
      'STEEL REFLEXES! TITANIUM MIND! YOU ARE A WAR MACHINE!',
      'LIGHT SPEED! SURGICAL PRECISION! YOU ARE PERFECTION!',
      'NO WALL STOPS YOU! NO OBSTACLE BRINGS YOU DOWN!',
      'YOU ARE NO LONGER A PLAYER... YOU ARE THE GAME ITSELF!',
      'THE DROP IS YOUR DOMAIN! NO ONE SURPASSES YOU!',
    ],
    motivationalBoost: [
      'YOU ARE CAPABLE OF INCREDIBLE FEATS! THE DROP IS YOUR STAGE!',
      'EVERY ATTEMPT BRINGS YOU CLOSER TO GLORY! DONT STOP NOW!',
      'THE ONLY LIMIT IS YOUR MIND! YOU WERE BORN FOR THIS!',
      'THE DROP AWAITS YOUR MASTER TOUCH, {name}!',
  ...
  es: {
    epicMoment: [
      '¡EL ABISMO SE ABRE PARA TI, {name}! ¡SIENTE EL PODER!',
      '¡LAS PAREDES TIEMBLAN! ¡SABEN QUE HAS LLEGADO!',
      '¡MOMENTO HISTÓRICO! ¡ESTÁS HACIENDO QUE ESTO SUCEDA!',
      '¡EL NEÓN LLORA DE EMOCIÓN! ¡ACTUACIÓN MAGNÍFICA!',
    ],
    spineChilling: [
      '¡LA PARED SINTIÓ EL IMPACTO DE TU ALMA, {name}!',
      '¡ENFRENTASTE EL ABISMO... Y EL ABISMO RETROCEDIÓ!',
      '¡SIENTE EL ESCALOFRÍO EN LA COLUMNA! ¡ES PODER PURO!',
      '¡POR UN MILÍMETRO ESCAPASTE DE LA MUERTE! ¡EL ABISMO TEMBLÓ!',
    ],
    addictiveReward: [
      '¡MIRA UN ANUNCIO Y OBTÉN OTRA OPORTUNIDAD! ¿NO QUIERES INTENTARLO DE NUEVO?',
      '¡LA GLORIA TE ESPERA! SOLO UN VIDEO MÁS Y VUELVES MÁS FUERTE!',
      '¿SIENTES ESA PICAZÓN DE QUERER MÁS? SOLO TIENES QUE CLICAR.',
    ],
    comebackKing: [
      '¡CAÍSTE, PERO TE LEVANTASTE MÁS FUERTE QUE NUNCA! ¡LA HISTORIA CONTINÚA!',
      '¡LA PARED PENSÓ QUE TE TENÍA... PERO ERES INDESTRUCTIBLE!',
      '¡RESURRECCIÓN ÉPICA! ¡EL ABISMO NUNCA VIO ALGO ASÍ!',
    ],
    recordBreaker: [
      '¡RÉCORD HISTÓRICO! ¡ESCRIBISTE TU NOMBRE EN LAS ESTRELLAS!',
      '¡EL ABISMO FUE TESTIGO DE LA GRANDEZA! ¡MOMENTO INOLVIDABLE!',
      '¡ROMPISTE BARRERAS! ¡ROMPISTE RÉCORDS!',
    ],
    intenseAction: [
      '¡REFLEJOS DE ACERO! ¡MENTE DE TITANIO! ¡ERES UNA MÁQUINA DE GUERRA!',
      '¡VELOCIDAD DE LA LUZ! ¡PRECISIÓN QUIRÚRGICA! ¡ERES PERFECCIÓN!',
      '¡NINGUNA PARED TE DETIENE! ¡NINGÚN OBSTÁCULO TE DERRUMBA!',
    ],
    motivationalBoost: [
      '¡ERES CAPAZ DE HAZAÑAS INCREÍBLES! ¡LA CAÍDA ES TU ESCENARIO!',
      '¡CADA INTENTO TE ACERCA MÁS A LA GLORIA! ¡NO TE DETENGAS AHORA!',
      '¡EL ÚNICO LÍMITE ES TU MENTE! ¡NACISTE PARA ESTO!',
    ],
    frenzyMode: [
...
export class NarratorManagerClass {
  ...
  private isAddictiveMode: boolean = false;
  private addictionCounter: number = 0;
  private adsWatched: number = 0;
  private currentVoiceStyle: string = 'viciante';
  ...
  public setAddictiveMode(enabled: boolean, voiceStyle: string = 'viciante'): void {
    this.isAddictiveMode = enabled;
    this.currentVoiceStyle = voiceStyle;
    if (enabled) {
      NarratorConfig.applyVoiceStyle(voiceStyle as keyof typeof VICIANTE_VOICE_PRESETS);
    }
  }

  public watchAd(settings: GameSettings): void {
    this.adsWatched++;
    const adPhrases: Record<string, string[]> = {
      pt: [
        `VOCÊ ASSISTIU ${this.adsWatched} ANÚNCIOS! O ABISMO ESTÁ ORGULHOSO!`,
        `MAIS UMA CHANCE, {name}! O PODER É SEU!`,
        `CADA ANÚNCIO TE DEIXA MAIS FORTE! QUER CONTINUAR?`,
        `VOCÊ É INCANSÁVEL! O NEON TE RECOMPENSA!`,
        `${this.adsWatched} ANÚNCIOS E VOCÊ CONTINUA AQUI! É ASSIM QUE SE FAZ!`,
      ],
      en: [
        `You watched ${this.adsWatched} ads! The abyss is proud!`,
        `Another chance, {name}! The power is yours!`,
        `Every ad makes you stronger! Want to continue?`,
        `You are relentless! The neon rewards you!`,
      ]
    };
    const lang = settings?.language || 'pt';
    const phrases = adPhrases[lang] || adPhrases['pt'];
    const phrase = this.formatPhrase(
      phrases[Math.floor(Math.random() * phrases.length)],
      settings
    );
    this.speakRaw(phrase, settings, 5);
    this.addictionCounter = 0;
  }

  private applySpineChillingEffects(phrase: string): string {
    ...
    if (!phrase.includes('...') && phrase.length > 20) {
      return phrase + '...';
    }
    return phrase;
  }
  ...
  public getPhrase(category: NarratorEventCategory, settings: GameSettings): string {
    ...
    const isViciante = this.isAddictiveMode || 
                       settings?.narratorVoiceStyle === 'viciante' ||
                       settings?.narratorVoiceStyle === 'arrepiante' ||
                       settings?.narratorVoiceStyle === 'epico' ||
                       settings?.narratorVoiceStyle === 'cinematic';

    if (isViciante) {
      const vicianteMap: Record<string, NarratorEventCategory> = {
        'start': 'epicMoment' as NarratorEventCategory,
        'welcome': 'epicMoment' as NarratorEventCategory,
        'combo3': 'intenseAction' as NarratorEventCategory,
        'combo5': 'intenseAction' as NarratorEventCategory,
        'combo10': 'recordBreaker' as NarratorEventCategory,
        'nearMiss': 'spineChilling' as NarratorEventCategory,
        'defeat': 'comebackKing' as NarratorEventCategory,
        'deathFast': 'comebackKing' as NarratorEventCategory,
        'deathUnexpected': 'comebackKing' as NarratorEventCategory,
        'highScore': 'recordBreaker' as NarratorEventCategory,
        'scoreMilestone': 'epicMoment' as NarratorEventCategory,
        'secondChance': 'comebackKing' as NarratorEventCategory,
        'frenzyMode': 'intenseAction' as NarratorEventCategory,
        'goldenRush': 'recordBreaker' as NarratorEventCategory,
        'liveHighScore': 'recordBreaker' as NarratorEventCategory,
        'ultraNearMiss': 'spineChilling' as NarratorEventCategory,
        'highStreak': 'intenseAction' as NarratorEventCategory,
        'comboMilestone': 'recordBreaker' as NarratorEventCategory,
      };

      if (vicianteMap[category]) {
        targetCategory = vicianteMap[category];
      }

      this.addictionCounter++;
      if (this.addictionCounter % 10 === 0 && this.addictionCounter > 0) {
        targetCategory = 'addictiveReward' as NarratorEventCategory;
      }
    }
    ...
    let finalPhrase = this.formatPhrase(chosen, settings);

    if (settings?.narratorVoiceStyle === 'arrepiante' || this.currentVoiceStyle === 'arrepiante') {
      finalPhrase = this.applySpineChillingEffects(finalPhrase);
    }
  ...
  public speak(
    ...
    if (isViciante) {
      const voiceStyle = settings?.narratorVoiceStyle || this.currentVoiceStyle || 'viciante';
      const preset = NarratorConfig.getVicianteVoice(voiceStyle as keyof typeof VICIANTE_VOICE_PRESETS);
      
      return libNarratorService.speak(
        phrase,
        {
          language: settings.language || 'pt',
          narratorVolume: (settings.narratorVolume ?? 1.0) * (preset.volume || 1.2),
          narratorSpeed: preset.speakingRate || NARRATOR_SPEED,
          phrasePauseMs: 3000,
  ...
  public getAddictionStats(): { adsWatched: number; phrasesSpoken: number; addictionLevel: number } {
    return {
      adsWatched: this.adsWatched,
      phrasesSpoken: this.addictionCounter,
      addictionLevel: Math.min(Math.floor(this.addictionCounter / 10), 10),
    };
  }
